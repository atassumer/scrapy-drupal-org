def separate_nodes_by_levels(dictionary):
    """
    >>> # simple format
    >>> two_level_dict = dict()
    ...
    ... ]
    >>> separate_nodes_by_levels(two_level_dict)
...
def flatten_nested_structure(structure):
    ...
    ...     'to': '/project/followup'
    ... }
    >>> list(flatten_nested_structure(structure))
    ...
    ...               {'to': '/project/followup'}]}
    >>> flattened = list(flatten_nested_structure(structure))
    >>> len(flattened)
    5
    >>> flattened[0]
